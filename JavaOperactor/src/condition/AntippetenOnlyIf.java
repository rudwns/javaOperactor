...
public class AntippetenOnlyIf {
	...
	public static void main(String[] args) {
		/*
		  구문 (statement) Java 연산식에서 3가지 종류의 구문으로 나뉜다. 
		...
		int x=1, y=2; //지변초기화
		if (x==y) {// 숫자값의 비교 연산자는 ==
			System.out.println("숫자x 와 y 의 값은 같다");
		}
		if (x != y) { // ! 는 부정(not) 연산자
			System.out.println("숫자 x 와 y 의값은 다르다");
		...
		/*
		  ...
		  코딩되어야 한다. 따라서 only If 문을 코딩할때는
		  개발자가 단 한가지 케이스만 출력할 것이라는 확신이
		  있을 때 다룬다.
		 */
